        ...
        <>
                        ...
                        <div className="modal-body">
                            <form className='my-3'>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="edescription" name="edescription" value={note.edescription} required minLength={5} onChange={onChange} />
                                </div>
                                <div className="mb-3">
            ...
            <div className="row my-3">
                ...
                <div className="container mx-2">
                    {notes.length === 0 && 'No content to display'}
                </div>
                {notes.map((note) => {
                    //   return note.etitle;
